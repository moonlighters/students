Функционал: Темы на форуме
  ...
  Сценарий: Просмотр темы
    Допустим у меня есть тема Срок годности на форуме О молоке c описанием "что-то" и сообщением "Почему пропадает?"
  ...
  Сценарий: Создание темы без логина
  ...
  Сценарий: Удаление темы
    ...
    То я должен увидеть "Тема удалена"
